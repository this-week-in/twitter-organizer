...
cf set-env ${APP_NAME} TWITTER_ORGANIZER_ACCESS_TOKEN_SECRET    ${TWITTER_ORGANIZER_ACCESS_TOKEN_SECRET}
cf set-env ${APP_NAME} TWITTER_ORGANIZER_ACCESS_TOKEN           ${TWITTER_ORGANIZER_ACCESS_TOKEN}
cf set-env ${APP_NAME} TWITTER_ORGANIZER_CLIENT_KEY             ${TWITTER_ORGANIZER_CLIENT_KEY}
cf set-env ${APP_NAME} TWITTER_ORGANIZER_CLIENT_KEY_SECRET      ${TWITTER_ORGANIZER_CLIENT_KEY_SECRET}
